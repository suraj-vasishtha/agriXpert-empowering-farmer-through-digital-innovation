<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rmc.aspx.cs" Inherits="agri.user.rmc" %>
...
<body>
    ...
    AGRIXPERT
     ...
     <li class="nav-item"><a class="nav-link" href="../shop/product.aspx">Shoping</a> </li>
        <li class="nav-item"><a class="nav-link" href="rmc.aspx">RMC</a> </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="event-post">
                             <iframe 
    src="https://www.napanta.com/market-price/karnataka/mysore/mysore-bandipalya" 
    width="100%" 
    height="600" 
